...
import styles from "../../../styles/components/projects/ProjectsIntroComponent.module.scss";
...
function ProjectsIntroComponent() {
    return (
        <section className={styles.container}>
            <Image src={"/static/projects/ProjectsBackground.png"} width={1920} height={1080} alt={""}/>
