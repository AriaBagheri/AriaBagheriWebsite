...
import styles from "../../../styles/components/certificates/CertificatesIntroComponent.module.scss";
import shapeDivider from "../../../styles/components/ShapeDivider.module.scss";

function CertificatesIntroComponent() {
    return (
        <section className={styles.container}>
            <Image src={"/certificatesHeaderImage.png"} alt={""}
                   className={styles.image}
                   height={500} width={1980}/>
...
export default CertificatesIntroComponent;