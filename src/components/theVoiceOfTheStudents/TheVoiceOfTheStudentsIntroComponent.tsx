...
import styles from "../../../styles/components/theVoiceOfTheStudents/TheVoiceOfTheStudentsIntroComponent.module.scss";
import shapeDivider from "../../../styles/components/ShapeDivider.module.scss";
import {BsArrowDownCircleFill} from "react-icons/bs";

function TheVoiceOfTheStudentsIntroComponent() {
    return (
        <Section isPadded={true} padSize={"medium"} className={styles.container}>
            <Image src={"/TheVoiceTheStudents.png"}
                   width={1920}
                   height={1080}
                   alt={""}/>
...
export default TheVoiceOfTheStudentsIntroComponent;